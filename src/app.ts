...
// CORS
const allowedOrigins = config.app.clientUrl.split(",").map((o) => o.trim());
app.use(
  cors({
...
// Auth-specific rate limiting BEFORE Better Auth
...
// Better Auth handler — this catches all /api/auth/* routes
app.all("/api/auth/*splat", toNodeHandler(auth));

// ============================================================
// Now the rest of the middleware for OTHER routes
// ============================================================
...
// Stripe webhook needs raw body — mount BEFORE /api/v1
